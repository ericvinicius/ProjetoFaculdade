...
BEGIN
    ...
    INSERT INTO Movimentacao (valor, data, novoSaldo, tipo, agenciaDestino, contaDestino, idCliente) VALUES (
		12.30, '2015-08-03 12:43:22', 1987.70, 'transferencia', '2345-6', '23.456-7', v1
	);

	INSERT INTO Movimentacao (valor, data, novoSaldo, tipo, agenciaDestino, contaDestino, idCliente) VALUES (
		123.50, '2015-08-02 01:17:30', 1864.20, 'transferencia', '3456-7', '34.567-8', v1
	);

	INSERT INTO Movimentacao (valor, data, novoSaldo, tipo, idCliente) VALUES (
		150.00, '2015-08-01 10:00:59', 1714.20, 'saque', v1
	);	
    
    INSERT INTO Movimentacao (valor, data, novoSaldo, tipo, idCliente) VALUES (
		10.00, '2015-08-01 17:50:59', 1704.20, 'saque', v1
	);	
